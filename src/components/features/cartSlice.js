...
// console.log("item===>",initialState.item)
...
getCartTotal:(state)=>{
     const {mainPrice,totalQuantity,totalPrice} = state.cart.reduce((cartTotal,cartItem)=>{
...
removeItem:(state,action)=>{
  ...
  console.log("remove==>",filterItem)
  state.cart.pop(filterItem);
},
...
export const {addTocart,removeItem,increaseItemQuantity,decreaseItemQuantity,getCartTotal,showHide_LoginForm,removeClassActive} = cartSlice.actions;
